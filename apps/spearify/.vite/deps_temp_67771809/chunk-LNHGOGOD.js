...
var require_safe_buffer = __commonJS({
  "../../node_modules/sha.js/node_modules/safe-buffer/index.js"(exports, module) {
...
function S(n2, l3, u3, t3, i3, o3, r3, f3, e3, c3, s3) {
  ...
  for (u3.__d = e3, $(u3, l3, _3), e3 = u3.__d, a3 = 0; a3 < g3; a3++) null != (y3 = u3.__k[a3]) && "boolean" != typeof y3 && "function" != typeof y3 && (v3 = -1 === y3.__i ? h : _3[y3.__i] || h, y3.__i = a3, O(n2, y3, v3, i3, o3, r3, f3, e3, c3, s3), d3 = y3.__e, y3.ref && v3.ref != y3.ref && (v3.ref && N(v3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), 65536 & y3.__u || v3.__k === y3.__k ? e3 = I(y3, e3, n2) : "function" == typeof y3.type && void 0 !== y3.__d ? e3 = y3.__d : d3 && (e3 = d3.nextSibling), y3.__d = void 0, y3.__u &= -196609);
  u3.__d = e3, u3.__e = w3;
}
function $(n2, l3, u3) {
...
function O(n2, u3, t3, i3, o3, r3, f3, e3, c3, s3) {
  ...
  n: if ("function" == typeof T3) try {
    ...
    h3.state = h3.__s, null != h3.getChildContext && (i3 = d(d({}, i3), h3.getChildContext())), x3 && !p3 && null != h3.getSnapshotBeforeUpdate && (_3 = h3.getSnapshotBeforeUpdate(v3, w3)), S(n2, y(L2 = null != a3 && a3.type === k && null == a3.key ? a3.props.children : a3) ? L2 : [L2], u3, t3, i3, o3, r3, f3, e3, c3, s3), h3.base = u3.__e, u3.__u &= -161, h3.__h.length && f3.push(h3), g3 && (h3.__E = h3.__ = null);
  } catch (n3) {
...
function z(l3, u3, t3, i3, o3, r3, f3, e3, c3) {
  ...
  if ("svg" === b3 ? o3 = "http://www.w3.org/2000/svg" : "math" === b3 ? o3 = "http://www.w3.org/1998/Math/MathML" : o3 || (o3 = "http://www.w3.org/1999/xhtml"), null != r3) {
    for (s3 = 0; s3 < r3.length; s3++) if ((d3 = r3[s3]) && "setAttribute" in d3 == !!b3 && (b3 ? d3.localName === b3 : 3 === d3.nodeType)) {
      l3 = d3, r3[s3] = null;
      break;
    }
  }
  if (null == l3) {
    ...
    l3 = document.createElementNS(o3, b3, k3.is && k3), r3 = null, e3 = false;
  }
  if (null === b3) m3 === k3 || e3 && l3.data === k3 || (l3.data = k3);
    ...
    else if (p3 && (l3.innerHTML = ""), S(l3, y(v3) ? v3 : [v3], u3, t3, i3, "foreignObject" === b3 ? "http://www.w3.org/1999/xhtml" : o3, r3, f3, r3 ? r3[0] : t3.__k && x(t3, 0), e3, c3), null != r3) for (s3 = r3.length; s3--; ) null != r3[s3] && w(r3[s3]);
...
safe-buffer/index.js:
  (*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> *)
*/
//# sourceMappingURL=chunk-LNHGOGOD.js.map
