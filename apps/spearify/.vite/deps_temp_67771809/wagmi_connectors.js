import {
  ...
  injected,
  mock
} from "./chunk-43H6G5HQ.js";
import "./chunk-X7SKBWBX.js";
import {
  withRetry,
  withTimeout
} from "./chunk-XKG3W5EO.js";
import {
  ResourceUnavailableRpcError,
  SwitchChainError,
  UserRejectedRequestError
} from "./chunk-CQ5RCFRR.js";
import "./chunk-RTMCI6AK.js";
import {
  getAddress,
  numberToHex
} from "./chunk-ZI4A64ZU.js";
import "./chunk-FDLVDN6N.js";
import "./chunk-B2BXIC3N.js";
import "./chunk-JYYCZ62U.js";
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-LEXMDYIG.js");
...
function version3(parameters) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-2CTNYUTX.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./@metamask_sdk.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-P2MKJOWC.js");
        ...
        const { SafeAppProvider } = await import("./dist-M2JTSJRN.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-T2JXIOTN.js");
